...
namespace _31.Scripts.Characters.Creation.Controllers.Movement
{
    public class MovementControllerCharacterCreator<TCharacter> : ICharacterCreator<TCharacter> where TCharacter : Character
    {
        ...
        private readonly MovementControllerCharacterInitializer<TCharacter> _initializer;
        ...
        public MovementControllerCharacterCreator(
            ...
            MovementControllerCharacterInitializer<TCharacter> initializer,
        ...
        public TCharacter Create(Vector3 position)
        {
            ...
            _initializer.Initialize(character, _inputConfig);
